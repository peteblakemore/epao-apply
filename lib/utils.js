...
exports.basicAuth = function(username, password) {
  return function(req, res, next) {
    if (!username || !password) {
      ...
      return res.send(
        '<h1>Error:</h1><p>Username or password not set. <a href="https://govuk-prototype-kit.herokuapp.com/docs/publishing-on-heroku#5-set-a-username-and-password">See guidance for setting these</a>.</p>'
      );
    }
...
exports.getLatestRelease = function() {
  ...
  if (releaseUrl !== null) {
    ...
    var gitHubUrl =
      'https://api.github.com/repos/alphagov/govuk-prototype-kit-private-beta/releases/latest';
    try {
      ...
      var urlStart =
        'https://github.com/alphagov/govuk-prototype-kit-private-beta/archive/';
      var urlEnd = '.zip';
      ...
      url =
        'https://github.com/alphagov/govuk-prototype-kit-private-beta/releases/latest';
...
exports.matchMdRoutes = function(req, res) {
  ...
  if (
    ...
    res.render('documentation_template', {
      document: this.markdownToHtml(doc)
    });
    return true;
  }
  return false;
